...
{
	public static class Pass73_FixUtf8String
	{
		...
		{
			Console.WriteLine("Pass 73: Fix Utf8String");

			TypeDefinition type = SharedState.TypeDictionary[Pass02_RenameSubnodes.Utf8StringName];
