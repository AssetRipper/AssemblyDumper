...
namespace AssemblyDumper.Passes
{
	public static class Pass52_FillYamlMethods
	{
		...
		private static void AddNodeForLoadedPair(this CilInstructionCollection processor, UnityNode pairNode)
		{
			...
			IMethodDefOrRef getKeyReference = SharedState.Importer.ImportMethod(MethodUtils.MakeMethodOnGenericType(getKeyDefinition, pairType));
			...
			IMethodDefOrRef getValueReference = SharedState.Importer.ImportMethod(MethodUtils.MakeMethodOnGenericType(getValueDefinition, pairType));
