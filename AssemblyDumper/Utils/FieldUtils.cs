...
namespace AssemblyDumper.Utils
{
	public static class FieldUtils
	{
		public static FieldDefinition AddIntField(this TypeDefinition typeDefinition, string name)
		{
			...
			var fieldDef = new FieldDefinition(name, FieldAttributes.Public, SystemTypeGetter.Int32(module));
		...
		{
			var module = typeDefinition.Module;
			var fieldDef = new FieldDefinition(name, FieldAttributes.Public | FieldAttributes.Static, SystemTypeGetter.Int32(module));
			typeDefinition.Fields.Add(fieldDef);
			return fieldDef;
		}
		...
		{
			var module = typeDefinition.Module;
			var fieldDef = new FieldDefinition(name, FieldAttributes.Public, SystemTypeGetter.UInt8(module));
			typeDefinition.Fields.Add(fieldDef);
			return fieldDef;
		}
		...
		{
			var module = typeDefinition.Module;
			var fieldDef = new FieldDefinition(name, FieldAttributes.Public, SystemTypeGetter.UInt8(module).MakeArrayType());
			typeDefinition.Fields.Add(fieldDef);
			return fieldDef;
		}
	}
